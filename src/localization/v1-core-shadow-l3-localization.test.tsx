...
const approvedReadings = [
	[ 'element:shadow-3-1/name', '仔細觀察' ], [ 'element:shadow-3-1/description', '只要專注片刻，就能將敵人牢牢鎖在視線內。' ], [ 'element:shadow-3-1/sections.0.text', '只要你與目標之間的距離仍在此招式射程內、維持效果線，而且沒有先打擊其他生物，你下次對目標發動的打擊會獲得 1 點鬥志與 1 個優勢。' ],
	[ 'element:shadow-ability-13/name', '舞者' ], [ 'element:shadow-ability-13/description', '你行雲流水的動作讓人難以將你困住。' ], [ 'element:shadow-ability-13/sections.0.text', '直到遭遇結束前，每當敵人移動或被強制移動到與你相鄰的位置，或對你造成傷害時，你可以使用免費反應動作執行撤離移動動作。' ],
	[ 'element:shadow-ability-14/name', '誤導打擊' ], [ 'element:shadow-ability-14/description', '你幹麼看我？！' ], [ 'element:shadow-ability-14/sections.1.text', '目標被你 5 格內的 1 個自願盟友嘲諷，直到目標下個回合結束。' ],
	[ 'element:shadow-ability-15/name', '牽制射擊' ], [ 'element:shadow-ability-15/description', '彈道精準，力道十足。' ], [ 'element:shadow-ability-16/name', '踉蹌重擊' ], [ 'element:shadow-ability-16/description', '這下有你好受的了。' ], [ 'element:shadow-3-2/name', '7 費招式' ],
	[ 'element:shadow-3-1/target', '1 個生物' ], [ 'element:shadow-ability-13/target', '自身' ], [ 'element:shadow-ability-14/target', '1 個生物' ], [ 'element:shadow-ability-15/target', '1 個生物' ], [ 'element:shadow-ability-16/target', '1 個生物' ],
	[ 'element:shadow-ability-14/sections.0.roll.tier1', '9 + `敏捷`傷害' ], [ 'element:shadow-ability-14/sections.0.roll.tier2', '13 + `敏捷`傷害' ], [ 'element:shadow-ability-14/sections.0.roll.tier3', '18 + `敏捷`傷害' ],
	[ 'element:shadow-ability-15/sections.0.roll.tier1', '8 + `敏捷`傷害；`敏捷` < [弱]，束縛（豁免解除）' ], [ 'element:shadow-ability-15/sections.0.roll.tier2', '12 + `敏捷`傷害；`敏捷` < [中]，束縛（豁免解除）' ], [ 'element:shadow-ability-15/sections.0.roll.tier3', '16 + `敏捷`傷害；`敏捷` < [強]，束縛（豁免解除）' ],
	[ 'element:shadow-ability-16/sections.0.roll.tier1', '7 + `敏捷`傷害；`力量` < [弱]，緩速（豁免解除）' ], [ 'element:shadow-ability-16/sections.0.roll.tier2', '11 + `敏捷`傷害；`力量` < [中]，伏地且無法站起（豁免解除）' ], [ 'element:shadow-ability-16/sections.0.roll.tier3', '16 + `敏捷`傷害；`力量` < [強]，伏地且無法站起（豁免解除）' ]
] as const;
